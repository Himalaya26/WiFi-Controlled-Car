...
int motor_L1 = 5; //pin D1 of nodemcu
int motor_L2 = 4; //pin D2 of nodemcu
int motor_R1 = 0; //pin D3 of nodemcu
int motor_R2 = 2; //pin D4 of nodemcu
...
void loop() {
 ...
 //////////// Wait until the client sends some data//////////////////////////////////////
  ...
  { analogWrite(motor_L1, Mspeed);
    analogWrite(motor_L2, 0);
    analogWrite(motor_R1, Mspeed);
